...
import { Component, bind, define, hyper, wire } from './hyperhtml/esm.js'
...
const getPrototypeOf = O.getPrototypeOf || (o => o.__proto__) // eslint-disable-line
const ownKeys = (typeof Reflect === 'object' && Reflect.ownKeys) ||
                (o => getOwnPropertyNames(o).concat(getOwnPropertySymbols(o)))
const setPrototypeOf = O.setPrototypeOf ||
                      ((o, p) => (o.__proto__ = p, o)) // eslint-disable-line
...
function checkReady (created) {
  if (dom.ready() || isReady.call(this, created)) {
    ...
    if (!this.hasOwnProperty('_init$$')) { defineProperty(this, '_init$$', { configurable: true, value: [] }) }
